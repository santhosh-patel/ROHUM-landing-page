...
const CubePage = () => {
  ...
  return (
    <div className=" text-[var(--foreground)] relative lg:mt-10 flex lg:flex-row flex-col justify-center items-center lg:min-h-[130vh] min-h-[120vh] p-2 w-full">
      ...
      <div className="w-full h-[65vh] lg:w-[50%] lg:h-screen">
        <CubeModel
